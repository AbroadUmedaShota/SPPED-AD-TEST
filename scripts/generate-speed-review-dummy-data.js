...
function main() {
    ...
    const surveyPath = path.join(__dirname, `../data/demo/demo_surveys/${surveyId}.json`);
    const answersPath = path.join(__dirname, `../data/demo/demo_answers/${surveyId}.json`);
    const businessCardsPath = path.join(__dirname, `../data/demo/demo_business-cards/${surveyId}.json`);
