...
*   **Principle of Communication Language:**
    ...
    *   **Artifacts Language:** All artifacts created for the user, such as `task.md` (Task List), `implementation_plan.md` (Implementation Plan), and `walkthrough.md` (Walkthrough), **must be written in Japanese**. This is to ensure the user can easily understand the plan and progress.
