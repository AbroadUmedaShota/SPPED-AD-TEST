...
| :-------------------- | :------------------------------------- |
| Issue Creation        | `docs/リファレンス/テンプレート/issue_body.md`         |
| Issue Comment         | `docs/リファレンス/テンプレート/issue_comment_body.md` |
| Pull Request Creation | `docs/リファレンス/テンプレート/pr_body.md`            |
| Pull Request Comment  | `docs/リファレンス/テンプレート/pr_comment_body.md`    |
...
5.  **Issue Creation:** Once approved, the AI will use the `gh issue create` command with the approved title and the standardized `docs/リファレンス/テンプレート/issue_body.md` file to create the Issue on GitHub.
...
2.  **AI's Response:**
    ...
    *   **Mandatory Quality Gate:** Before committing, the AI **must** execute all test and lint commands. This is a non-negotiable gate.
        *   The AI must first check for the existence of `docs/ハンドブック/テスト/03_TESTING_GUIDELINES.md`.
    ...
    *   **Create a Pull Request:** To ensure the Pull Request body consistently includes the required issue link, the AI must follow this procedure:
        1.  Open the `docs/リファレンス/テンプレート/pr_body.md` file.
        2.  Replace the `#{issue_number}` placeholder with the current issue number and update the description.
        3.  Create the Pull Request using the prepared `docs/リファレンス/テンプレート/pr_body.md` file.
            *   **Command:** `gh pr create --title "..." --body-file docs/リファレンス/テンプレート/pr_body.md`
...
I will proceed with these changes."
    ...
    *   **Verify Locally:** The AI **must** re-run all relevant quality checks (tests, linting) as defined in `docs/ハンドブック/テスト/03_TESTING_GUIDELINES.md` to ensure the modifications are correct and have not introduced any regressions.
...
*   **Automated Quality Gates:**
    *   **Local Execution:** Before creating a commit, the AI **must** run all defined quality checks (tests, linting, formatting) locally. The successful execution of these checks, guided by `docs/ハンドブック/テスト/03_TESTING_GUIDELINES.md` (if it exists), is a mandatory prerequisite for creating a Pull Request.
*   **Project-Specific Guidelines:**
    *   The specific commands, tools, and configurations for testing and linting for this project should be defined in `docs/ハンドブック/テスト/03_TESTING_GUIDELINES.md`. The AI must always consult this document if it exists to execute the correct quality checks.
...
documentation:
  ...
  - file: "[CHANGELOG.md](docs/変更履歴/CHANGELOG.md)"
  ...
  - file: "[docs/プロダクト/概要/00_PROJECT_OVERVIEW.md](docs/プロダクト/概要/00_PROJECT_OVERVIEW.md)"
  ...
  - file: "[docs/プロダクト/アーキテクチャ/01_ARCHITECTURE.md](docs/プロダクト/アーキテクチャ/01_ARCHITECTURE.md)"
  ...
  - file: "[docs/プロダクト/標準・規準/02_CODING_STANDARDS.md](docs/プロダクト/標準・規準/02_CODING_STANDARDS.md)"
  ...
  - file: "[docs/ハンドブック/テスト/03_TESTING_GUIDELINES.md](docs/ハンドブック/テスト/03_TESTING_GUIDELINES.md)"
  ...
  - file: "[docs/ハンドブック/セットアップ/04_SETUP.md](docs/ハンドブック/セットアップ/04_SETUP.md)" 
  ...
  - file: "[docs/ハンドブック/デプロイ/05_DEPLOYMENT.md](docs/ハンドブック/デプロイ/05_DEPLOYMENT.md)"
  ...
  - file: "[docs/ハンドブック/運用/06_OPERATIONS_GUIDE.md](docs/ハンドブック/運用/06_OPERATIONS_GUIDE.md)"
  ...
  - file: "[docs/ハンドブック/セキュリティ/07_SECURITY_GUIDELINES.md](docs/ハンドブック/セキュリティ/07_SECURITY_GUIDELINES.md)"
  ...
  - file: "[docs/変更履歴/08_DECISION_LOG.md](docs/変更履歴/08_DECISION_LOG.md)"
...
*   **Splitting Method:**
    1.  **Create a Subdirectory:** Create a subdirectory corresponding to the original file name (e.g., `docs/プロダクト/アーキテクチャ/01_ARCHITECTURE.md` -> `docs/プロダクト/アーキテクチャ/`).
    ...
    3.  **Create a Table of Contents:** Update the original document file (in this example, `docs/プロダクト/アーキテクチャ/01_ARCHITECTURE.md`) to function as a **Table of Contents**, containing links to each of the split files.
