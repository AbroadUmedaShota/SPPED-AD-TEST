// steps-bizcard.js
// 名刺データ化設定チュートリアル ステップ定義（仕様書 §4.5・全 18 ステップ）。
//
...
export const TUTORIAL_STEPS = [
  ...
  // ブロック C: プラン選択
  {
    id: 5, block: 'C', target: '#dataConversionPlanSelection', mode: 'info', placement: 'top',
    title: 'データ化プランを選択',
    body:
      'ここでデータ化プランを選択します。プランは「納期の速さ」と「1枚あたりの単価」で分かれます。\n\n'
      + '・お試し：無料／6営業日／2項目\n'
      + '・通常（おすすめ）：＠50円／6営業日／10項目\n'
      + '・特急：＠100円／3営業日／10項目\n'
      + '・超特急：＠150円／1営業日／10項目\n'
      + '・オンデマンド：＠200円／当日中／10項目\n\n'
      + '各プランの詳しい違いは、右上の『詳細仕様を見る』からいつでも確認できます。\n'
      + '迷ったら「通常」が標準的です。確認できたら、下の『次へ』ボタンを押してください。',
  },
  {
    id: 6, block: 'C', target: 'label:has(#data-plan-onDemand)', mode: 'info', placement: 'top',
    title: 'オンデマンドはプレミアム限定',
    body:
      '「オンデマンド」は当日納期の最速プランで、プレミアムプラン限定です。\n'
      + '通常・特急・超特急は、無料プランでも選べます。\n\n'
      + '確認できたら、下の『次へ』ボタンを押してください。',
  },
  {
  ...
  // ブロック D: 見込み枚数入力
  {
    id: 9, block: 'D', target: '#bizcardRequest', mode: 'autofill', placement: 'top',
    title: '見込み枚数を入力',
    body:
      'ここで会期中に集める名刺の見込み枚数を入力します。見込み枚数をもとに料金が見積もられます。\n'
      + '練習のため『100』を自動入力しました。実際の枚数と異なる場合も、会期開始前まで変更できます。\n\n'
      + '確認できたら、下の『次へ』ボタンを押してください。',
    autoInput: { kind: 'text', value: '100' },
  },
  {
    id: 10, block: 'D', target: '#bizcardRequestStepper', mode: 'info', placement: 'top',
    title: '枚数を増減する（＋1・＋10・＋100）',
    body:
      '見込み枚数は、このボタンでまとめて増減できます。\n'
      + '『＋』で1枚ずつ、『＋10』で10枚ずつ、『＋100』で100枚ずつ増やせます。\n'
      + '（『−』『−10』『−100』で同じように減らせます。）\n'
      + '実際に押して枚数が変わることを確かめたら、下の『次へ』ボタンを押してください。',
  },
  {
    id: 11, block: 'D', target: '#minChargeNotice', mode: 'info', placement: 'top',
    title: '最低請求バッジについて',
    body:
  ...
  // ブロック E: プレミアムオプション
  {
    id: 12, block: 'E', target: '#premiumOptionsContainer', mode: 'info', placement: 'top',
    title: 'プレミアムオプション',
    body:
      ...
      + '気になるオプションがあれば選択してみてください。選択は任意です。\n'
      + '確認できたら、下の『次へ』ボタンを押してください。',
  },
  {
    id: 13, block: 'E', target: '#toggleMemoSection', mode: 'info', placement: 'top',
    ...
    body:
      ...
      + 'この練習では入力しません。『次へ』ボタンを押してください。',
  },
  {
    id: 14, block: 'E', target: '#estimatedCompletionDate', mode: 'info', placement: 'left',
    title: '完了予定日を確認',
    body:
      '右カラムに完了予定日が表示されます。\n'
      + '名刺データ化がおおよそいつ頃完了するかの目安です。\n\n'
      + 'クーポンや詳細内訳は、別のチュートリアルで詳しく説明します。\n\n'
      + '確認できたら、下の『次へ』ボタンを押してください。',
  },

  // ブロック F: 右カラム確認 & 保存
  {
    id: 15, block: 'F', target: '.estimate-block-survey-total', mode: 'info', placement: 'left',
    title: 'アンケート全体料金ブロック',
    body:
      '右カラムの『アンケート全体料金』には、\n'
  ...
  {
    id: 16, block: 'F', target: '#couponSectionWrapper', mode: 'info', placement: 'left',
    title: 'クーポン・詳細内訳について',
    body:
      '右カラムには割引クーポン欄や詳細内訳もあります。\n'
      + 'これらは別のチュートリアルで詳しく説明します。\n\n'
      + '確認できたら、下の『次へ』ボタンを押してください。',
  },
  {
    id: 17, block: 'F', target: '#saveBizcardSettingsBtn', mode: 'user-action-bridge', placement: 'top',
  ...
  {
    id: 18, block: 'F', target: null, mode: 'user-action-bridge', placement: 'center',
    title: 'チュートリアル完了',
    body:
      'お疲れさまでした！\n'
