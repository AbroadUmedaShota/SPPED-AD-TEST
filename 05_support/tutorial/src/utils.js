...
const DEFAULT_DEMO_ROOT = './data/demo';
...
const DASHBOARD_DATA_ROOT = DASHBOARD_BASE_PATH ? `${DASHBOARD_BASE_PATH}/data` : DEFAULT_DATA_ROOT;
...
function getDemoDataRoot() {
  if (DASHBOARD_BASE_PATH) {
    return `${DASHBOARD_BASE_PATH}/data/demo`;
  }
