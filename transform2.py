...
if '<div id="fullpage">' not in html:
    ...
    footer_wrapper = f'\\n    <footer id="before-footer" style="padding: 5vh 0; background: linear-gradient(180deg, #899bb3, #4b525d); margin: 0; color: white; display: flex; flex-direction: column; justify-content: center; align-items: center; width: 100%; height: 45vh; box-sizing: border-box;">{new_footer_html}</footer>\\n  </article>\\n    </div>\\n'
