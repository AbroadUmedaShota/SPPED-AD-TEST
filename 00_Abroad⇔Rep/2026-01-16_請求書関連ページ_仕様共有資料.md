...
- 画面/機能要件（ユーザー画面）: `docs/product/specs/04_invoice_screen.md:1`
- INV-002 詳細画面要件: `docs/product/specs/04_invoice_detail_requirements.md:1`
- 帳票（PDF/印刷）要件: `docs/product/specs/05_invoice_document.md:1`
- 手動テスト: `docs/handbook/testing/invoice_manual_checklist.md:1`
...
- 旧資料など（料金比較/表記の参照資料）：`docs/references/resources/client-materials/service-plan-comparison.md`
...
- **請求単位とフラグ:**
    - プレミアムプランの契約は、「個人アカウント」または「グループ」のいずれかの単位で行われます。
    - 契約単位はプレミアムフラグによって管理されます。
- **請求書の宛先:**
    - **個人契約の場合:** プレミアムプランの月額費用は、フラグが立てられた**個人アカウント**に対して請求されます。
    - **グループ契約の場合:** プレミアムプランの月額費用は、フラグが立てられた**グループ**に対して請求されます。請求書はグループの管理者に送付されます。
- **機能の利用範囲:**
    - **個人契約の場合:** プレミアム機能は、契約した個人のみが利用できます。そのユーザーが所属するグループでは利用できません。
    - **グループ契約の場合:** プレミアム機能は、契約したグループに所属する全てのメンバーが利用できます。ただし、メンバー個人のアカウントとしてプレミアム機能を利用することはできません。
- **料金体系:**
    - プレミアムプランは月額固定料金です。プランに含まれる高度なオプション機能に対して、追加の従量課金は発生しません。
