...
- 画面/機能要件（ユーザー画面）: `docs/プロダクト/specs/04_invoice_screen.md:1`
- INV-002 詳細画面要件: `docs/プロダクト/specs/04_invoice_detail_requirements.md:1`
- 帳票（PDF/印刷）要件: `docs/プロダクト/specs/05_invoice_document.md:1`
...
- 旧資料など（料金比較/表記の参照資料）：`docs/リファレンス/リソース/client-materials/service-plan-comparison.md`
