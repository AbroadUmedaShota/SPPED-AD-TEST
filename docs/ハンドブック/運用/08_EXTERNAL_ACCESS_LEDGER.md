...
npx --yes @google/clasp -u customer redeploy AKfycbw6xaQvmfspOOxXEs4DMqfLxQ3Aev6Qi8RcfiFu7iFwOHos48eAPvmmjxSnteN1Lj0D --versionNumber 11 --description "support contact viewer token links"
```
