...
**利用方法の詳細は既存の `02_dashboard/common/` と `02_dashboard/src/ui/` の実装、および shared の画面仕様を参照してください。**
...
- **[docs/リファレンス/共有規約/01_SHARED_CODING_STANDARDS.md](../../リファレンス/共有規約/01_SHARED_CODING_STANDARDS.md)**: 共有repoでの実装規約。
- **`docs/画面設計/仕様/` ディレクトリ**: 各画面・機能ごとの詳細な仕様書。

これらの shared 文書を読み、画面仕様と開発プロセスを理解した上で、作業を開始してください。
