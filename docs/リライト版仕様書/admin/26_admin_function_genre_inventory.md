...
flowchart TB
    ...
    subgraph G1["機能群1: 顧客・契約準備"]
      N1A["顧客アカウントを発行する<br/>↓<br/>AD-02 招待・再送"]
      N1B["契約プラン・請求先を最新化<br/>↓<br/>AD-11 基本情報・請求先・契約プラン更新"]
      N1C["内部メモを追加<br/>↓<br/>AD-11 内部メモ"]
    end

    subgraph G2["機能群2: アンケート設定・公開"]
      N2A["アンケート案件を新規作成<br/>↓<br/>AD-03 新規登録"]
      N2B["会期・基本情報を設定<br/>↓<br/>AD-12 基本情報・会期編集"]
      N2C["フォーム構成・設問を編集<br/>↓<br/>AD-12 フォーム編集"]
      N2D["既存アンケートを複製して使う<br/>↓<br/>AD-12 複製"]
      N2E["公開状態を切替<br/>↓<br/>AD-12 公開状態変更"]
      N2F["名刺データ化条件を確認<br/>↓<br/>AD-12 名刺データ化条件"]
    end

    subgraph G3["機能群3: 運用条件確認"]
      N3A["クーポン条件を確認・設定<br/>↓<br/>AD-05 クーポン管理"]
      N3B["営業日・休業日・SLAを確認<br/>↓<br/>AD-06 営業日カレンダー管理"]
    end
...
flowchart TB
    ...
    subgraph G1["機能群1: 運用入口"]
      N1A["対象案件へ到達する<br/>↓<br/>AD-01 ダッシュボード"]
    end

    subgraph G2["機能群2: 稼働状況・進捗確認"]
      N2A["アンケート稼働状況を一覧で見る<br/>↓<br/>AD-03 アンケート管理"]
      N2B["ID/名称/会期等で絞り込む<br/>↓<br/>AD-03 検索・フィルタ"]
    end

    subgraph G3["機能群3: 詳細確認・運用判断"]
      N3A["回答状況を確認<br/>↓<br/>AD-12 回答状況"]
      N3B["回答データを確認<br/>↓<br/>AD-12 回答データ"]
      N3C["名刺データ化の処理予定を確認<br/>↓<br/>AD-12 名刺データ化条件"]
      N3D["運用タスクを確認<br/>↓<br/>AD-12 運用タスク"]
    end
...
flowchart TB
    ...
    subgraph G1["機能群1: 名刺データ取込"]
      N1A["CSV取込状況・エラーを確認<br/>↓<br/>AD-12 取込状況・エラー"]
      N1B["必要なら再取込を実行<br/>↓<br/>AD-12 再取込"]
    end

    subgraph G2["機能群2: データ入力"]
      N2A["入力タスクの未完了数・進捗を確認<br/>↓<br/>AD-07 データ入力一覧"]
      N2B["入力対象を選択しフォームを開始<br/>↓<br/>AD-07 → AD-13 起動"]
      N2C["名刺画像を確認して項目入力<br/>↓<br/>AD-13 入力フォーム"]
      N2D["入力状態を更新<br/>↓<br/>AD-13 状態遷移"]
    end

    subgraph G3["機能群3: 照合"]
      N3A["照合対象のアンケート一覧を見る<br/>↓<br/>AD-08 照合管理一覧"]
      N3B["照合タスクを開く<br/>↓<br/>AD-14 照合タスク一覧"]
      N3C["OCR・入力・確定値を比較し確定<br/>↓<br/>AD-15 照合詳細"]
      N3D["項目ごとに確定値を選択・編集・保存<br/>↓<br/>AD-15 確定値編集"]
    end

    subgraph G4["機能群4: エスカレーション対応"]
      N4A["不一致や確認要項目をエスカレ起票<br/>↓<br/>AD-15 エスカレ起票"]
      N4B["エスカレ案件を一覧・詳細確認<br/>↓<br/>AD-16 エスカレ対応"]
      N4C["対応結果を反映しクローズ<br/>↓<br/>AD-16 対応・クローズ"]
    end
...
flowchart TB
    ...
    subgraph G1["機能群1: 完了状況確認"]
      N1A["名刺データ化の完了状況を確認<br/>↓<br/>AD-08 照合管理一覧"]
      N1B["完成データを確認<br/>↓<br/>AD-08 完成データ"]
    end

    subgraph G2["機能群2: 成果物取得"]
      N2A["名刺データをダウンロード<br/>↓<br/>AD-03 行アクション: 名刺DL"]
      N2B["回答データをダウンロード<br/>↓<br/>AD-12 CSV ダウンロード"]
      N2C["レポートをダウンロード<br/>↓<br/>AD-03 行アクション: レポートDL"]
      N2D["進捗サマリをCSV出力<br/>↓<br/>AD-08 進捗サマリCSV"]
      N2E["アンケート詳細から成果物を確認<br/>↓<br/>AD-12 アンケート詳細"]
    end
...
flowchart TB
    ...
    subgraph G1["機能群1: 請求一覧・詳細確認"]
      N1A["請求一覧を見る<br/>↓<br/>AD-04 請求管理"]
      N1B["請求状況を切り替えて確認<br/>↓<br/>AD-04 表示切替"]
      N1C["請求詳細を見る<br/>↓<br/>AD-04 請求詳細"]
    end

    subgraph G2["機能群2: 請求書作成・編集"]
      N2A["新規請求書を作成<br/>↓<br/>AD-04 新規作成"]
      N2B["請求情報を編集<br/>↓<br/>AD-04 編集"]
    end

    subgraph G3["機能群3: 入金管理"]
      N3A["入金確認を登録<br/>↓<br/>AD-04 入金確認"]
      N3B["請求PDFを確認<br/>↓<br/>AD-04 PDF"]
      N3C["入金待ち案件へリマインド<br/>↓<br/>AD-04 リマインド送信"]
    end

    subgraph G4["機能群4: 出力・通知・横断参照"]
      N4A["請求一覧をCSV出力<br/>↓<br/>AD-04 CSV出力"]
      N4B["ユーザー詳細/アンケート詳細から関連請求を辿る<br/>↓<br/>AD-11 関連請求 ／ AD-12 関連請求"]
    end
