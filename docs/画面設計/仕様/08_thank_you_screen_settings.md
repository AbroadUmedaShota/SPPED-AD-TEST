...
- **連動するボタン**: アンケート作成画面の「名刺データ化設定」「サンクスメール設定」は自動的に無効化され、ツールチップで理由を表示する。
- **表示メッセージ**: ページ内に赤字で「名刺撮影を依頼しない場合、名刺データ化設定とサンクスメール設定は利用できません。」を表示する。
...
- **一貫性**: アプリケーション全体のデザインガイドライン (`docs/プロダクト/UIデザイン/00_design_guideline.md`) に準拠する。
