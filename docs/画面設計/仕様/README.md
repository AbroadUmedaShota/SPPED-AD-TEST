...
`docs/画面設計/仕様/` は、サービス画面と管理者画面の要件定義・機能仕様の正本です。管理者画面要件は既存資料を削除したうえで、新ルールに従って完全新規で再作成します。
...
- `admin/`: 管理者画面資料の正本置き場。まず `00_admin_documentation_rules.md` に従う。
- `premium/`: プレミアム登録・契約管理の要件群。

## 正本ルール
- 新規仕様は必ず `docs/画面設計/仕様/` に作成する。管理者画面資料は `docs/画面設計/仕様/admin/` に作成する。
