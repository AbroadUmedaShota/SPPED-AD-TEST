...
- 画面/機能要件（ユーザー画面）: `docs/画面設計/specs/04_invoice_screen.md:1`
- INV-002 詳細画面要件: `docs/画面設計/specs/04_invoice_detail_requirements.md:1`
- 帳票（PDF/印刷）要件: `docs/画面設計/specs/05_invoice_document.md:1`
