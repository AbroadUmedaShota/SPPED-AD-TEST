...
- 共有コーディング規約: `../リファレンス/共有規約/01_SHARED_CODING_STANDARDS.md`
- shared/private 境界: `../リファレンス/共有規約/02_SHARED_DOC_BOUNDARY_RULES.md`
- AI/実装責任分界: `../リファレンス/共有規約/04_AI_RESPONSIBILITY_BOUNDARY.md`
- 実装の正本CSS: `../../02_dashboard/service-top-style.css`
- 管理画面拡張CSS: `../../03_admin/src/admin-style.css`

## 運用ルール

- 実装に必要な仕様を更新する場合は、`docs/画面設計/仕様/` または `docs/リファレンス/共有規約/` 側を更新する。
- shared 側の画面仕様、共有規約、正本CSSの配置を変える場合は、`docs/README.md` とこの stub の導線も同時に更新する。
