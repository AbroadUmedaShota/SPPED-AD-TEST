...
- **根拠**: サイドバーHTML内のラベルおよび `populateGroupSelect` のデフォルトオプションが固定文字列になっています。【F:02_dashboard/common/sidebar.html†L9-L22】【F:02_dashboard/src/sidebarHandler.js†L135-L151】 shared repo の既存 UI では動的に現在グループ名を出し分ける前提であり、固定表示は仕様と乖離しています。
