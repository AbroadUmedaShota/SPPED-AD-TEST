...
If a file is needed by the product experience, move a copy into `02_dashboard/assets/` and document the dependency. Otherwise, keep reference-only artefacts in this directory or under `アーカイブ/`.
