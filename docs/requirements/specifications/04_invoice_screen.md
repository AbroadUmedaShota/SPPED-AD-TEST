...
### 3.2 補助マスタ
- `plan.displayName`・`addOns.displayName` は `docs/resources/client-materials/service-plan-comparison.md` を唯一の参照元とし、表記揺れを許容しない。
- `status` は以下に固定：
...
- `docs/resources/client-materials/service-plan-comparison.md`（サービスプラン比較表）
