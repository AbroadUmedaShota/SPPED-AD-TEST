...
- `create_issue.sh`: GitHub CLI helper that files the feature request issue using `docs/リファレンス/テンプレート/issue_body.md`. It resolves the template relative to the repository root.
