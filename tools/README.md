...
- `create_issue.sh`: GitHub CLI helper that files the feature request issue using `docs/references/templates/issue_body.md`. It resolves the template relative to the repository root.
